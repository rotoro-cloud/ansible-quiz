var questions = [
    {
        ...
        "subText": "`Замени IP неймсервера в этом playbook, чтобы использовалось значение переменной из inventory-файла`, таким образом в будущем, когда потребуется внести изменения ты легко сможешь поправить лишь файл inventory.",
        "files" : [
          {
